...
interface CumplimientoPadrinoProps {
  data: CumplimientoItem[];
}

export function CumplimientoPadrino({ data }: CumplimientoPadrinoProps) {
  if (data.length === 0) {
    return (
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Cumplimiento por Padrino</h3>
